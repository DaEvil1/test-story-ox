...
|---|---:|---|---:|---:|---|---:|
| ch03-s03 the stair decision | 3 | scene | 1 | 0 | no | 5 |
| ch04-s04 return to Sera | 4 | transition | 1 | 0 | no | 3 |
| ch07-s03 exit resolve | 7 | transition | 1 | 0 | no | 3 |
| ch05-s03 resolve to find missing pieces | 5 | transition | 3 | 0 | no | 4 |
| ch06-s01 spindle introduced | 6 | scene | 3 | 1 | no | 5 |
| ch02-s03 the niche coin | 2 | scene | 4 | 1 | no | 4 |
| ch02-s04 withdrawal under refusal | 2 | scene | 4 | 1 | no | 6 |
